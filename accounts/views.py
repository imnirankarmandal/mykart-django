            ...
            try:
                ...
                if is_cart_item_exists:
                    ...
                    for item in cart_item:
                        variatrion = item.variations.all()
                        variation_list.append(list(variation))
                    ...
                    #variation_list = [1, 2, 3, 4, 6]
                    #existing_variation_list = [4, 6, 3, 5]
                    for vr in variation_list:
                        if vr in existing_variation_list:
                            index = existing_variation_list.index(vr)
                            item_id = id[index]
